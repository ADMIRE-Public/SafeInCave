...
class ModelML():
    def __init__(self):
        with open(os.path.join(HERE, "model3.pkl"), "rb") as file:
...
def compute_mesh_h(mesh):
    with open(os.path.join(HERE, "models_h", "model3.pkl"), "rb") as file:
