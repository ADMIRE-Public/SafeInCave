...
from safeincave.Thermo.CavernThermodynamics import CavernThermodynamics
...
def main():
    ...
    fig.subplots_adjust(
        top=0.935, bottom=0.155, left=0.062, right=0.980, hspace=0.35, wspace=0.38
    )
