...
def plot_results(ax_shape, ax_closure, results_folder, mesh_folder, case_name="name", line_style="-", case_color="purple"):
	...
	pvd_path = os.path.join(results_folder, "u")
	pvd_file = "u.pvd"
...
def main():
	...
	results_folder = os.path.join("output", mesh_name, "model_e_ve_cr", "EXP", "operation")
	...
	# mesh_name = "cavern_irregular"
	# results_folder = os.path.join("output", mesh_name, "model_e_ve_vp_cr", "EXP", "operation")
	# mesh_folder = os.path.join("..", "..", "grids", mesh_name)
	# plot_results(ax3, ax2, results_folder, mesh_folder, case_name="Cavern B", line_style="-", case_color="#ff7f00")
