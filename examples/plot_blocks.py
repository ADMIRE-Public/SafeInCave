...
def plot_results(ax, pvd_path, color_name="steelblue", sty="-", label_name=""):
	...
	ax.plot(time/hour, 100*eps_axi, sty, color=color_name, label=label_name)
	ax.plot(time/hour, 100*eps_rad, sty, color=color_name)
...
def main():
	...
	plot_results(ax, os.path.join("salt_block", "output", "case_e_ve", "vtk", "displacement"), color_name="lightcoral", sty="-", label_name="Old")
	plot_results(ax, os.path.join("salt_block_new", "output", "case_e_ve", "vtk", "displacement"), color_name="steelblue", sty=".", label_name="New")
