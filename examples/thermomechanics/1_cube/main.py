...
def main():
    ...
    t_control = sf.TimeControllerParabolic(
        n_time_steps=100, initial_time=0.0, final_time=10, time_unit="day"
    )
    ...
    bc_east = heatBC.DirichletBC(
        boundary_name="EAST", values=nt * [273 + 1.0], time_values=time_values
    )
    ...
    # Boundary conditions
    bc_west_2 = momBC.DirichletBC(
        boundary_name="WEST", component=2, values=nt * [0.0], time_values=time_values
    )

    bc_west_1 = momBC.DirichletBC(
        boundary_name="WEST", component=1, values=nt * [0.0], time_values=time_values
    )

    bc_west_0 = momBC.DirichletBC(
        boundary_name="WEST", component=0, values=nt * [0.0], time_values=time_values
    )

    bc_bottom = momBC.DirichletBC(
        boundary_name="BOTTOM", component=2, values=nt * [0.0], time_values=time_values
    )
