...
def main():
    ...
    fig.subplots_adjust(
        top=0.92, bottom=0.155, left=0.093, right=0.980, hspace=0.35, wspace=0.295
    )

    points, time_list, u_field = post.read_node_vector(
        os.path.join(results_folder, "u", "u.xdmf")
    )
