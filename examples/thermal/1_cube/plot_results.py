...
def main():
    ...
    fig.subplots_adjust(
        top=0.90, bottom=0.15, left=0.11, right=0.980, hspace=0.35, wspace=0.293
    )
    ...
    apply_grey_theme(
        fig, [ax1, ax2], transparent=True, grid_color="0.92", back_color="0.85"
    )
