...
def main():
    ...
    points, time_list, T_field = post.read_node_scalar(
        os.path.join(results_folder, "T", "T.xdmf")
    )
    ...
    fig.subplots_adjust(
        top=0.90, bottom=0.15, left=0.143, right=0.980, hspace=0.35, wspace=0.293
    )
